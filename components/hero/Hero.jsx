      ...
      <section className="bg-gray-100">
        <div className="h-screen max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col justify-center items-center h-full text-center">
            ...
            <Link
              href="/builder"
              className="inline-block bg-[#16A34A] text-[#16A34A] px-6 py-3 rounded-lg font-bold text-lg hover:bg-fuchsia-600 transition duration-200 hover:-translate-y-1 transform hover:shadow-lg"
            >
              Make My Resume
            </Link>
          </div>
