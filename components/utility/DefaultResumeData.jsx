const DefaultResumeData = {
  ...
  profilePicture: "",
  summary:
    "12 months of experience in B2B digital marketing and sales, achieving organic outreach and sales conversion through custom-built information models, with a good understanding of client relationship management. Goal-focused individual with an analytical approach to solving problems with good communication and presentation skills",
  workExperience: [
    {
      company: "Torph TTC",
      position: "Developer",
  ...
  education: [
    {
      degree: "B.E",
      year: "2020-08-20",
      school: "Anna Universty",
      cgpa: "44%",
    },
    {
      degree: "M.E",
      year: "2020-08-20",
      school: "Madras Univesity",
      cgpa: "44%",
    },
  ],
  ...
  skills: [
    {
      ...
      skills: ["JavaScript", "Python", "Web Services"],
    },
  ],
  extraActivities: ["English", "Hindi"],
  awards: [
